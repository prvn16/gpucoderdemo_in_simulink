  ...
  real32_T *Image, real32_T *expanded)
{
  ...
  if ((!(int32_T)(k >= 240)) && (!(int32_T)(ocol >= 320))) {
  ...
  *expanded, real32_T *resX)
{
  ...
  for (y_idx = srow; y_idx <= 33; y_idx += strideRow) {
    ...
    for (x_idx = scol; x_idx <= 33; x_idx += strideCol) {
      if (((int32_T)(((int32_T)(baseR >= 0)) && ((int32_T)(baseR < 242)))) &&
          ((int32_T)(((int32_T)(baseC >= 0)) && ((int32_T)(baseC < 322))))) {
  ...
  __syncthreads();
  if ((!(int32_T)(threadIdX >= 240)) && (!(int32_T)(threadIdY >= 320))) {
    cv = 0.0F;
    for (n = 0; n < 3; n++) {
      for (k = 0; k < 3; k++) {
