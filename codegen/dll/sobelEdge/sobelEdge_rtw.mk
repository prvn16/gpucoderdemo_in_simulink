...
## Generated on : Sun Jan 14 07:04:33 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\sobelEdge.dll
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Sumpurn\gpucoderdemo_in_simulink
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\sobelEdge.dll
...
INCLUDES_BUILDINFO = $(START_DIR)\codegen\dll\sobelEdge;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
SRCS = $(START_DIR)\codegen\dll\sobelEdge\sobelEdge_initialize.cu $(START_DIR)\codegen\dll\sobelEdge\sobelEdge_terminate.cu $(START_DIR)\codegen\dll\sobelEdge\sobelEdge.cu $(START_DIR)\codegen\dll\sobelEdge\rt_nonfinite.cu $(START_DIR)\codegen\dll\sobelEdge\rtGetNaN.cu $(START_DIR)\codegen\dll\sobelEdge\rtGetInf.cu
...
{$(START_DIR)\codegen\dll\sobelEdge}.cu.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"


{$(START_DIR)\codegen\dll\sobelEdge}.c.obj :
	$(CC) $(CFLAGS) -o  "$@" "$<"
...
{$(START_DIR)\codegen\dll\sobelEdge}.cpp.obj :
	$(CPP) $(CPPFLAGS) -o  "$@" "$<"
