...
MODEL     = gpucoder_sobelEdge
TARGET      = sfun
MODULE_SRCS   = c2_gpucoder_sobelEdge.c
MODEL_SRC  = gpucoder_sobelEdge_sfun.c
MODEL_REG = gpucoder_sobelEdge_sfun_registry.c
MAKEFILE    = gpucoder_sobelEdge_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Sumpurn\gpucoderdemo_in_simulink\slprj\_sfprj\gpucoder_sobelEdge\_self\sfun\src" 

COMPILER_INCLUDES = /I "$(MSVC_ROOT)\include"

THIRD_PARTY_INCLUDES   =  /I "C:\Sumpurn\gpucoderdemo_in_simulink\codegen\dll\sobelEdge"
...
OBJLIST_FILE = gpucoder_sobelEdge_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
